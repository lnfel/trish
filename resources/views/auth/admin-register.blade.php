  ...
  <div class="w-full">
    ...
    <form class="px-8 pt-6 pb-8 mb-4 mx-auto" method="POST" action="{{ route('admin.register.submit') }}" style="width: 70%;">
      ...
      <div class="mb-4">
        ...
        <input id="first_name" type="text" class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50" name="first_name" value="{{ old('first_name') }}" required autocomplete="first_name" autofocus>
        @error('first_name')
      ...
      <div class="mb-4">
        ...
        <input id="last_name" type="text" class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50" name="last_name" value="{{ old('last_name') }}" required autocomplete="last_name">
        @error('last_name')
          <span class="is-invalid" role="alert">
            <strong>{{ $message }}</strong>
          </span>
      ...
      <div class="mb-4">
        ...
        <input id="email" type="email" name="email" class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50" value="{{ old('email') }}" required>
        @error('email')
          <span class="is-invalid" role="alert">
            <strong>{{ $message }}</strong>
          </span>
