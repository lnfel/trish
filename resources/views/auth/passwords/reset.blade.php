...
<div class="flex items-center items-stretch min-h-screen">
  <div class="w-full">
    ...
    <form class="px-8 pt-6 pb-8 mb-4 mx-auto" method="POST" action="{{ route('password.update') }}" style="width: 70%;">
      @csrf

      <input type="hidden" name="token" value="{{ $token }}">

      <h3 class="text-xl font-bold text-gray-700 mb-4">Reset Password</h3>
      <div class="mb-4">
