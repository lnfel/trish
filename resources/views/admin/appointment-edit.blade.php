...
<section class="relative container mx-auto px-4 mb-4 -mt-80" style="z-index: 9;">
	<div class="bg-white shadow-md rounded-lg p-4">
		...
		<form x-data="format()" method="post" action="{{ route('client.user.appointments.update', $appointment->id) }}" class="mt-4">
			@csrf
			@method('PATCH')
			<div class="mb-4">
				...
				<div class="w-64">
					<div class="relative">
						...
						<input
							...
							id="status"
							class="w-full pl-4 pr-10 py-3 leading-none rounded-lg shadow focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50 text-gray-600 font-medium" placeholder="Select Status">
